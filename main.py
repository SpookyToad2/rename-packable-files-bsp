...
# Particles
try:
    maps_path = os.chdir(f'{TF2_Directory}/maps')
except FileNotFoundError as err:
    print("\nERROR: INVALID TF2 PATH! Change it in config.txt\n\n EXAMPLE: TF2 PATH; E:\Games\Steam\steamapps\common\Team Fortress 2\\tf \n\n", err)
    #exit()
    while True:
        ("sus")
